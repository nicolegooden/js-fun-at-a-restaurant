...
function chooseToOrder() {
if (inStock < 20) {
  var shouldOrderMore = true;
  return shouldOrderMore;
} else {
...
var vegetables = ["broccoli", "carrots", "zucchini", "green beans", "eggplant"]
...
var fruits = ["apple", "pear", "orange", "watermelon", "strawberry", "banana", "blueberry"]
